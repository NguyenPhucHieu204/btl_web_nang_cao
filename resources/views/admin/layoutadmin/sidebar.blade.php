  ...
  <div class="sidebar-logo">
    ...
    <div class="logo-header" data-background-color="dark">
      <a href="index.html" class="logo">
        <img src="{{ asset('img/logo_admin.png') }}" alt="Thương hiệu thanh điều hướng" class="navbar-brand" height="50" />
      </a>
        ...
        <li class="nav-item active">
          ...
          <div class="collapse" id="dashboard">
            <ul class="nav nav-collapse">
              <li><a href="{{ route('admin.brand.index') }}"><span class="sub-item">Danh sách</span></a></li>
              <li><a href="{{ route('admin.brand.create') }}"><span class="sub-item">Thêm mới</span></a></li>
            </ul>
          </div>
        </li>
        <li class="nav-item active">
